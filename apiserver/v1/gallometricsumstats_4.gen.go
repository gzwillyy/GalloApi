...
const TableNameGalloMetricSumStats4 = "galloMetricSumStats_4"

// GalloMetricSumStats4 指标统计总和数据
type GalloMetricSumStats4 struct {
...
// TableName GalloMetricSumStats4's table name
func (*GalloMetricSumStats4) TableName() string {
	return TableNameGalloMetricSumStats4
}
