...
const TableNameGalloMetricSumStat = "galloMetricSumStats"

// GalloMetricSumStat 指标统计总和数据
type GalloMetricSumStat struct {
...
// TableName GalloMetricSumStat's table name
func (*GalloMetricSumStat) TableName() string {
	return TableNameGalloMetricSumStat
}
