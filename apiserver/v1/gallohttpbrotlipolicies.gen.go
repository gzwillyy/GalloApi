...
const TableNameGalloHTTPBrotliPolicy = "galloHTTPBrotliPolicies"

// GalloHTTPBrotliPolicy Gzip配置
type GalloHTTPBrotliPolicy struct {
...
// TableName GalloHTTPBrotliPolicy's table name
func (*GalloHTTPBrotliPolicy) TableName() string {
	return TableNameGalloHTTPBrotliPolicy
}
