...
const TableNameGalloMetricSumStats2 = "galloMetricSumStats_2"

// GalloMetricSumStats2 指标统计总和数据
type GalloMetricSumStats2 struct {
...
// TableName GalloMetricSumStats2's table name
func (*GalloMetricSumStats2) TableName() string {
	return TableNameGalloMetricSumStats2
}
