...
const TableNameGalloMetricSumStats8 = "galloMetricSumStats_8"

// GalloMetricSumStats8 指标统计总和数据
type GalloMetricSumStats8 struct {
...
// TableName GalloMetricSumStats8's table name
func (*GalloMetricSumStats8) TableName() string {
	return TableNameGalloMetricSumStats8
}
