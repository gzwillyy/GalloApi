...
// GalloNodeCluster 节点集群
type GalloNodeCluster struct {
	...
	GrantID              int32  `gorm:"column:grantId;comment:默认认证方式" json:"grantId"`                                 // 默认认证方式
	...
	DNSDomainID          int32  `gorm:"column:dnsDomainId;comment:域名ID" json:"dnsDomainId"`                           // 域名ID
	DNS                  string `gorm:"column:dns;comment:DNS配置" json:"dns"`                                          // DNS配置
	Toa                  string `gorm:"column:toa;comment:TOA配置" json:"toa"`                                          // TOA配置
	CachePolicyID        int32  `gorm:"column:cachePolicyId;comment:缓存策略ID" json:"cachePolicyId"`                     // 缓存策略ID
	HTTPFirewallPolicyID int32  `gorm:"column:httpFirewallPolicyId;comment:WAF策略ID" json:"httpFirewallPolicyId"`      // WAF策略ID
	...
	NodeMaxThreads       int32  `gorm:"column:nodeMaxThreads;comment:节点最大线程数" json:"nodeMaxThreads"`                  // 节点最大线程数
...
// TableName GalloNodeCluster's table name
func (*GalloNodeCluster) TableName() string {
