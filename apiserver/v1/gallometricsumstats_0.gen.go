...
const TableNameGalloMetricSumStats0 = "galloMetricSumStats_0"

// GalloMetricSumStats0 指标统计总和数据
type GalloMetricSumStats0 struct {
...
// TableName GalloMetricSumStats0's table name
func (*GalloMetricSumStats0) TableName() string {
	return TableNameGalloMetricSumStats0
}
