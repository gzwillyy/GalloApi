...
type Server struct {
	...
	WebID               uint64  `gorm:"column:webId;comment:WEB配置" json:"webId"`                                            // WEB配置
	...
	Version             uint64  `gorm:"column:version;comment:版本号" json:"version"`                                          // 版本号
	...
	UserPlanID          uint64  `gorm:"column:userPlanId;comment:所属套餐ID" json:"userPlanId"`                                 // 所属套餐ID
	LastUserPlanID      uint64  `gorm:"column:lastUserPlanId;comment:上一次使用的套餐" json:"lastUserPlanId"`                       // 上一次使用的套餐
