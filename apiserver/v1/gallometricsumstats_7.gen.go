...
const TableNameGalloMetricSumStats7 = "galloMetricSumStats_7"

// GalloMetricSumStats7 指标统计总和数据
type GalloMetricSumStats7 struct {
...
// TableName GalloMetricSumStats7's table name
func (*GalloMetricSumStats7) TableName() string {
	return TableNameGalloMetricSumStats7
}
