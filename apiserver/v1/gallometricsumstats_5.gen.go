...
const TableNameGalloMetricSumStats5 = "galloMetricSumStats_5"

// GalloMetricSumStats5 指标统计总和数据
type GalloMetricSumStats5 struct {
...
// TableName GalloMetricSumStats5's table name
func (*GalloMetricSumStats5) TableName() string {
	return TableNameGalloMetricSumStats5
}
