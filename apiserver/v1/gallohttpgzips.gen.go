...
const TableNameGalloHTTPGzip = "galloHTTPGzips"

// GalloHTTPGzip Gzip配置
type GalloHTTPGzip struct {
...
// TableName GalloHTTPGzip's table name
func (*GalloHTTPGzip) TableName() string {
	return TableNameGalloHTTPGzip
}
