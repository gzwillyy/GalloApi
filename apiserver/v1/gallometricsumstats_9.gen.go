...
const TableNameGalloMetricSumStats9 = "galloMetricSumStats_9"

// GalloMetricSumStats9 指标统计总和数据
type GalloMetricSumStats9 struct {
...
// TableName GalloMetricSumStats9's table name
func (*GalloMetricSumStats9) TableName() string {
	return TableNameGalloMetricSumStats9
}
