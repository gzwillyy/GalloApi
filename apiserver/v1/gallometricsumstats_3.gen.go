...
const TableNameGalloMetricSumStats3 = "galloMetricSumStats_3"

// GalloMetricSumStats3 指标统计总和数据
type GalloMetricSumStats3 struct {
...
// TableName GalloMetricSumStats3's table name
func (*GalloMetricSumStats3) TableName() string {
	return TableNameGalloMetricSumStats3
}
