...
// GalloHTTPWeb HTTP Web
type GalloHTTPWeb struct {
	...
	Gzip               string `gorm:"column:gzip;comment:Gzip配置（v0.3.2弃用）" json:"gzip"`                        // Gzip配置（v0.3.2弃用）
...
// TableName GalloHTTPWeb's table name
func (*GalloHTTPWeb) TableName() string {
