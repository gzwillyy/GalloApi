...
const TableNameGalloMetricSumStats6 = "galloMetricSumStats_6"

// GalloMetricSumStats6 指标统计总和数据
type GalloMetricSumStats6 struct {
...
// TableName GalloMetricSumStats6's table name
func (*GalloMetricSumStats6) TableName() string {
	return TableNameGalloMetricSumStats6
}
