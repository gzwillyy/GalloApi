...
const TableNameGalloMetricSumStats1 = "galloMetricSumStats_1"

// GalloMetricSumStats1 指标统计总和数据
type GalloMetricSumStats1 struct {
...
// TableName GalloMetricSumStats1's table name
func (*GalloMetricSumStats1) TableName() string {
	return TableNameGalloMetricSumStats1
}
